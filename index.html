...
<html lang="en">
    <head>
        ...
        <style>
            .card {
                width: 90%;  /* Adjust the card size */
            }
            
            .card-header h2 {
                font-size: 20px;  /* Decrease the font size of the title */
            }
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5"> <!-- Decreased column size -->
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control form-control-sm" name="username" type="text" placeholder="Username" required />
